...
type RuneEntry struct {
	...
	Burned       *Uint128       `protobuf:"bytes,12,opt,name=burned,proto3" json:"burned,omitempty"`
...
func (x *RuneEntry) GetHolderCount() uint64 {
	if x != nil {
...
type OutpointToBalancesValue struct {
	...
	UtxoId     uint64       `protobuf:"varint,1,opt,name=UtxoId,proto3" json:"UtxoId,omitempty"`
	AddressId  uint64       `protobuf:"varint,3,opt,name=AddressId,proto3" json:"AddressId,omitempty"`
	RuneIdLots []*RuneIdLot `protobuf:"bytes,4,rep,name=rune_id_lots,json=runeIdLots,proto3" json:"rune_id_lots,omitempty"`
}

func (x *OutpointToBalancesValue) Reset() {
	*x = OutpointToBalancesValue{}
	if protoimpl.UnsafeEnabled {
...
func (x *OutpointToBalancesValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OutpointToBalancesValue) ProtoMessage() {}

func (x *OutpointToBalancesValue) ProtoReflect() protoreflect.Message {
	mi := &file_indexer_runes_pb_runes_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OutpointToBalancesValue.ProtoReflect.Descriptor instead.
func (*OutpointToBalancesValue) Descriptor() ([]byte, []int) {
	return file_indexer_runes_pb_runes_proto_rawDescGZIP(), []int{12}
}

func (x *OutpointToBalancesValue) GetUtxoId() uint64 {
	if x != nil {
		return x.UtxoId
	}
	return 0
...
func (x *OutpointToBalancesValue) GetAddressId() uint64 {
	if x != nil {
		return x.AddressId
	}
	return 0
...
func (x *OutpointToBalancesValue) GetRuneIdLots() []*RuneIdLot {
	if x != nil {
		return x.RuneIdLots
	}
	return nil
...
type OutpointToBalances struct {
	...
	Value *OutpointToBalancesValue `protobuf:"bytes,1,opt,name=value,proto3" json:"value,omitempty"`
}
...
func (x *OutpointToBalances) GetValue() *OutpointToBalancesValue {
	if x != nil {
		return x.Value
	}
	return nil
...
type RuneIdToMintHistory struct {
	...
	UtxoId uint64 `protobuf:"varint,1,opt,name=UtxoId,proto3" json:"UtxoId,omitempty"`
	Amount *Lot   `protobuf:"bytes,2,opt,name=Amount,proto3" json:"Amount,omitempty"`
}
...
func (x *RuneIdToMintHistory) GetUtxoId() uint64 {
	if x != nil {
		return x.UtxoId
	}
	return 0
...
func (x *RuneIdToMintHistory) GetAmount() *Lot {
	if x != nil {
		return x.Amount
	}
	return nil
...
type RuneAddressBalance struct {
	...
	Balance   *Lot   `protobuf:"bytes,3,opt,name=Balance,proto3" json:"Balance,omitempty"`
}
...
func (x *RuneAddressBalance) GetAddressId() uint64 {
	if x != nil {
		return x.AddressId
	}
	return 0
...
func (x *RuneIdAddressToBalance) Reset() {
	*x = RuneIdAddressToBalance{}
	if protoimpl.UnsafeEnabled {
...
func (x *RuneIdAddressToBalance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RuneIdAddressToBalance) ProtoMessage() {}

func (x *RuneIdAddressToBalance) ProtoReflect() protoreflect.Message {
	mi := &file_indexer_runes_pb_runes_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RuneIdAddressToBalance.ProtoReflect.Descriptor instead.
func (*RuneIdAddressToBalance) Descriptor() ([]byte, []int) {
	return file_indexer_runes_pb_runes_proto_rawDescGZIP(), []int{20}
}

func (x *RuneIdAddressToBalance) GetAddressId() uint64 {
	if x != nil {
		return x.AddressId
	}
	return 0
...
func (x *RuneIdAddressToBalance) GetBalance() *Lot {
	if x != nil {
		return x.Balance
	}
	return nil
...
type AddressOutpointToBalance struct {
	...
	AddressId uint64  `protobuf:"varint,1,opt,name=AddressId,proto3" json:"AddressId,omitempty"`
	RuneId    *RuneId `protobuf:"bytes,2,opt,name=runeId,proto3" json:"runeId,omitempty"`
	Balance   *Lot    `protobuf:"bytes,3,opt,name=Balance,proto3" json:"Balance,omitempty"`
}

func (x *AddressOutpointToBalance) Reset() {
	*x = AddressOutpointToBalance{}
	if protoimpl.UnsafeEnabled {
...
func (x *AddressOutpointToBalance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddressOutpointToBalance) ProtoMessage() {}

func (x *AddressOutpointToBalance) ProtoReflect() protoreflect.Message {
	mi := &file_indexer_runes_pb_runes_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddressOutpointToBalance.ProtoReflect.Descriptor instead.
func (*AddressOutpointToBalance) Descriptor() ([]byte, []int) {
	return file_indexer_runes_pb_runes_proto_rawDescGZIP(), []int{21}
}

func (x *AddressOutpointToBalance) GetAddressId() uint64 {
	if x != nil {
		return x.AddressId
	}
	return 0
...
func (x *AddressOutpointToBalance) GetRuneId() *RuneId {
	if x != nil {
		return x.RuneId
	}
	return nil
...
func (x *AddressOutpointToBalance) GetBalance() *Lot {
	if x != nil {
		return x.Balance
	}
	return nil
...
var file_indexer_runes_pb_runes_proto_rawDesc = []byte{
	...
	0x66, 0x73, 0x65, 0x74, 0x22, 0xad, 0x04, 0x0a, 0x09, 0x52, 0x75, 0x6e, 0x65, 0x45, 0x6e, 0x74,
	...
	,
	...
	0x0a, 0x05, 0x74, 0x75, 0x72, 0x62, 0x6f, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x74,
	0x75, 0x72, 0x62, 0x6f, 0x22, 0x7e, 0x0a, 0x0b, 0x52, 0x75, 0x6e, 0x65, 0x73, 0x53, 0x74, 0x61,
	...
	,
	...
	,
...
var file_indexer_runes_pb_runes_proto_goTypes = []any{
	...
	(*OutpointToBalancesValue)(nil),    // 12: pb.runes.OutpointToBalancesValue
	(*OutpointToBalances)(nil),         // 13: pb.runes.OutpointToBalances
	(*RuneIdToAddress)(nil),            // 14: pb.runes.RuneIdToAddress
	(*RuneIdToOutpoint)(nil),           // 15: pb.runes.RuneIdToOutpoint
	(*RuneIdToMintHistory)(nil),        // 16: pb.runes.RuneIdToMintHistory
	(*AddressRuneIdToMintHistory)(nil), // 17: pb.runes.AddressRuneIdToMintHistory
	(*RuneBalance)(nil),                // 18: pb.runes.RuneBalance
...
var file_indexer_runes_pb_runes_proto_depIdxs = []int32{
	...
	1,  // 5: pb.runes.RuneEntry.divisibility:type_name -> pb.runes.Uint8
	4,  // 6: pb.runes.RuneEntry.parent:type_name -> pb.runes.InscriptionId
	0,  // 7: pb.runes.RuneEntry.mints:type_name -> pb.runes.Uint128
	0,  // 8: pb.runes.RuneEntry.premine:type_name -> pb.runes.Uint128
	5,  // 9: pb.runes.RuneEntry.spaced_rune:type_name -> pb.runes.SpacedRune
	6,  // 10: pb.runes.RuneEntry.symbol:type_name -> pb.runes.Symbol
	7,  // 11: pb.runes.RuneEntry.terms:type_name -> pb.runes.Terms
	0,  // 12: pb.runes.RuneEntry.burned:type_name -> pb.runes.Uint128
	...
	11, // 16: pb.runes.OutpointToBalancesValue.rune_id_lots:type_name -> pb.runes.RuneIdLot
	12, // 17: pb.runes.OutpointToBalances.value:type_name -> pb.runes.OutpointToBalancesValue
	10, // 18: pb.runes.RuneIdToMintHistory.Amount:type_name -> pb.runes.Lot
	10, // 19: pb.runes.RuneBalance.Balance:type_name -> pb.runes.Lot
	10, // 20: pb.runes.RuneAddressBalance.Balance:type_name -> pb.runes.Lot
	10, // 21: pb.runes.RuneIdAddressToBalance.Balance:type_name -> pb.runes.Lot
	2,  // 22: pb.runes.AddressOutpointToBalance.runeId:type_name -> pb.runes.RuneId
	10, // 23: pb.runes.AddressOutpointToBalance.Balance:type_name -> pb.runes.Lot
...
func file_indexer_runes_pb_runes_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_indexer_runes_pb_runes_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Uint8); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indexer_runes_pb_runes_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*RuneId); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indexer_runes_pb_runes_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Rune); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indexer_runes_pb_runes_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Symbol); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indexer_runes_pb_runes_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Terms); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indexer_runes_pb_runes_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*Lot); i {
			case 0:
				return &v.state
			case 1:
		...
		file_indexer_runes_pb_runes_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*OutpointToBalancesValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indexer_runes_pb_runes_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[15].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[16].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[17].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[18].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[19].Exporter = func(v any, i int) any {
		...
		file_indexer_runes_pb_runes_proto_msgTypes[20].Exporter = func(v any, i int) any {
			switch v := v.(*RuneIdAddressToBalance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indexer_runes_pb_runes_proto_msgTypes[21].Exporter = func(v any, i int) any {
			switch v := v.(*AddressOutpointToBalance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_indexer_runes_pb_runes_proto_msgTypes[22].Exporter = func(v any, i int) any {
