...
func calcInputValueAge(tx *wire.MsgTx, utxoView *common.UtxoViewpoint, nextBlockHeight int32) float64 {
...
func CalcPriority(tx *wire.MsgTx, utxoView *common.UtxoViewpoint, nextBlockHeight int32) float64 {
