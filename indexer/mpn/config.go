...
// MPNConfig defines the configuration options for btcd.
//
...
func btcdDial(addr net.Addr) (net.Conn, error) {
	if strings.Contains(addr.String(), ".onion:") {
		return _cfg.oniondial(addr.Network(), addr.String(),
			defaultConnectTimeout)
	}
	return _cfg.dial(addr.Network(), addr.String(), defaultConnectTimeout)
}
